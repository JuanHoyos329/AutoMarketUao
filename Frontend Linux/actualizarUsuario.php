...
$api_url = "http://192.168.100.3:808/automarketuao/users/read/" . urlencode($emailToEdit);
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {  
    ...
    if (!empty($data)) {  
        ...
        $update_url = "http://192.168.100.3host:8081/automarketuao/users/update/" . urlencode($userToEdit['email']); 
