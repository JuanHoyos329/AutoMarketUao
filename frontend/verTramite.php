...
$tramiteId = $_GET["id"];
$apiUrl = "http://localhost:8082/api/tramites/" . $tramiteId;
    ...
    <script>
        $(document).ready(function() {
            $(".actualizarPaso").click(function() {
                ...
                $.ajax({
                    url: `http://localhost:8082/api/tramites/paso/${tramiteId}`,
                    type: "PUT",
            ...
            $("#cancelarTramite").click(function() {
                ...
                $.ajax({
                    url: `http://localhost:8082/api/tramites/cancel/${tramiteId}`,
                    type: "PUT",
                    contentType: "application/json",
